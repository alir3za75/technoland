...
const Category = () => {
    ...
    useEffect(() => {
        ...
        if (activeCatImage == 'mobile-accessories'){
            setImageCat('/images/mainCat/mobile-accessories.jpg');
        }
    
        else if (activeCatImage == 'headphone-headset-microphone'){
            setImageCat('/images/mainCat/headphone-headset-microphone.jpg');
        }
        else if (activeCatImage == 'speaker'){
            setImageCat('/images/mainCat/speaker.jpg');
        }
        else if (activeCatImage == 'computer-parts'){
            setImageCat('/images/mainCat/computer-parts.jpg');
        }
        else if (activeCatImage == 'notebook-netbook-ultrabook'){
            setImageCat('/images/mainCat/notebook-netbook-ultrabook.jpg');
        }
        else if (activeCatImage == 'compact-disc'){
            setImageCat('/images/mainCat/compact-disc.jpg');
        }
        else if (activeCatImage == 'other'){
            setImageCat('/images/mainCat/other.jpg');
        }
